...
function Missile.Fire(entity)
    if entity.cannon == "right" then
      ...
      bullet = MissileShot.new(entity,leftCannonOffsetX,leftCannonOffsetY,300,entity.rotation, entity.weaponDamage,5)
    ...
    elseif entity.cannon == "left" then
      ...
      bullet = MissileShot.new(entity,rightCannonOffsetX,rightCannonOffsetY,300,entity.rotation, entity.weaponDamage,5)
      table.insert(entity.bullets, bullet)
    end
